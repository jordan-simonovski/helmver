...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&base, "base", "", "base git ref to compare against; auto-detected from CI env (GITHUB_BASE_REF, BITBUCKET_PR_DESTINATION_BRANCH, CI_MERGE_REQUEST_TARGET_BRANCH_NAME, CI_DEFAULT_BRANCH), falls back to origin/main")
